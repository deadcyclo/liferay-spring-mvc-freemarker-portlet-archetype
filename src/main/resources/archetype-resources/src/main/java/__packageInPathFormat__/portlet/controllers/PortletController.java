...
import ${package}.common.portlet.CustomPropsUtil;
import ${package}.portlet.beans.DummyObject;
...
import ${package}.portlet.keys.ResourceKeys;
import ${package}.portlet.validators.DemoValidator;
